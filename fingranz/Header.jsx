...
const Header = () => {
    ...
    // iOS and Mobile Viewport Scrolling Lock
    useEffect(() => {
        if (isMobileMenuOpen) {
            ...
            <div className="container">
                <nav className="navbar">
                    <div className="logo" onClick={() => window.scrollTo(0,0)}>
                        ...
                        <img src="images/company_logo/logo.jpeg" alt="Fingranz Logo" width="38" height="38" style={{ objectFit: 'contain' }} />
                        </span>
                        <div className="logo-brand">
                            <span className="logo-name">{language === 'en' ? 'Fingranz' : 'ಫಿನ್ಮಾಕ್ಸ್'}</span>
